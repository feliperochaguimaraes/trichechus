...
{
	public class UpdateAtividadeDtoValidator : AbstractValidator<UpdateAtividadeDto>
	{
		public UpdateAtividadeDtoValidator()
		{
			// RuleFor(dto => dto.Id)
			// 	.NotEmpty().WithMessage("O ID da atividade é obrigatório.");
