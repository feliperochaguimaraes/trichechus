...
public class CatalogoController : ControllerBase
{
	...
	[HttpGet]
	// [SwaggerOperation(Summary = "Obtém todos os catalogoes", Description = "Retorna uma lista com todos os catalogoes cadastrados")]
	...
	[HttpPost]
	[SwaggerOperation(Summary = "Cria um novo catalogo", Description = "Cria uma novo catalogo com os dados fornecidos")]
